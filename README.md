...
<head>
    ...
    <style>
        ...
        .crown-symbol { font-size: 4rem; color: var(--24k-gold); }
...
<body>
    ...
    <section class="intro">
        ...
        <p>Enhance your natural beauty with help from BethStarRoyal Corp.</p>
    </section>
    ...
    <section class="owner-section">
        <div class="owner-box">
            ...
            <p>Joan leads BethStarRoyal Corp with a commitment to luxury and empowerment.</p>
        </div>
    </section>
